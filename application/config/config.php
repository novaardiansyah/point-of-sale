...
|
*/
$config['base_url'] = 'http://localhost:8080/project/novaardiansyah/point-of-sale/';
...
$config['csrf_token_name']   = 'csrf_novasite';
$config['csrf_cookie_name']  = 'csrf_cookie_novasite';
