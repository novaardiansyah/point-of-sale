                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-text es-p10t es-p20b es-p30r es-p30l es-m-p5r es-m-p5l">
                                              <p>As you've probably noticed, your account is currently rocking a password that's a bit on the weaker side. No worries, though! We're all about keeping things safe and secure.</p>
                                              <br />
                                              <p>Ready to level up your account's defense? It's as easy as a click. Just hit that button below to give your password a superhero upgrade. Your future self will be high-fiving you for this smart move.</p>
                                            </td>
                                          </tr>
                                          <tr>
                                              ...
                                              <!--[if mso]>
																													<a href="" target="_blank" hidden>
																														<v:roundrect
																															...
																															xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="" 
                style="height:54px; v-text-anchor:middle; width:232px" arcsize="11%" stroke="f"  fillcolor="#5c68e2">
																															<w:anchorlock></w:anchorlock>
																															<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:20px; font-weight:400; line-height:20px;  mso-text-raise:1px'>Change Password</center>
																														</v:roundrect>
																													</a>
																													<![endif]-->
                                              <!--[if !mso]>
																													<!-- -->
                                              <span class="msohide es-button-border" style="border-radius: 6px;">
                                                <a href class="es-button es-button-1691481492511" target="_blank" style="border-radius: 6px; padding: 15px 25px">Change Password</a>
                                              </span>
                                              <!--
																													<![endif]-->
                                            </td>
                                          ...
                                          <tr>
                                            <td align="right" class="esd-block-text es-p25t es-p10b es-p30r es-p30l es-m-p5r es-m-p5l">
                                              <p>Kind Regards, <br type="_moz">
                                              </p>
                                              <p>
                                                <br>
                                              </p>
                                              <p>Nova Ardiansyah <br type="_moz">
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
